// dvr_xrsim32 - a simulated 32-bit OpenXR runtime for agent-driven testing.
//
// This is NOT part of the mod. It links nothing from dishonoredvr and ships in no
...
// xrsim.log exactly the way it follows dishonoredvr.log.
namespace log {
void init();
const wchar_t* dir();          // %LOCALAPPDATA%\DishonoredVR\xrsim, or $DVR_XRSIM_DIR
