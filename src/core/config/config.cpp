...
static void WriteDefaultIni(const char* ini)
{
    ...
    fprintf(f,
        ...
        "; Switch live with the command `swing mode edge` or in F10.\n"
        "Enabled=1\n"
        "Detector=sustain\n"
        "SwingSpeed=1.8\n"
        "SwingMs=120\n"
        ...
        "; you do not slash: Stab=1 makes a THRUST of the sword hand - straight out\n"
        "; from your shoulder, the way you are facing - press the attack while you are\n"
        "; crouched. The game decides what the attack becomes: behind an unaware guard\n"
