...
static void WriteDefaultIni(const char* ini)
{
    ...
    fprintf(f,
        ...
        "Census=0\n"
        "[Hud]\n"
        "; Experimental world-space weapon dial (F10 HUD); enable for testing.\n"
        "WeaponDial=0\n"
        "WeaponDialDirectionOnly=1\n"
        "WeaponDialDeadzone=0.002\n"
        "WeaponDialCircle=1\n"
        "WeaponDialDistance=0.000\n"
        "WeaponDialAlphaGain=3.000\n"
        "WeaponDialAlphaFloor=0.000\n"
        "WeaponDialAlphaGamma=0.500\n"
        "NoteFollowHand=0\n"
        "NoteHandWidth=0.600\n"
        "NoteHandDistance=-0.050\n"
        "NoteHandRight=0.200\n"
        "JournalFollowHand=0\n"
        "JournalHandWidth=0.700\n"
        "JournalHandDistance=-0.050\n"
        "JournalHandRight=0.200\n"
        "HeadLookPause=0\n"
        "NoBlurPause=0\n"
        "HeadLookNote=0\n"
        "NoBlurNote=0\n"
        ...
        "WeaponDialWidth=0.350\n"
        "WeaponDialRadius=0.040\n"
        "WeaponDialCropX=0.400\n"
        "WeaponDialCropY=0.400\n"
        ...
        "Element.default.WinX=0.053\n"
        "Element.default.WinY=0.185\n"
        "Element.default.WinScale=1.410\n"
        ...
        "Element.vitals.HandX=0.097\n"
        "Element.vitals.HandY=-0.096\n"
        "Element.vitals.HandScale=0.330\n"
        "Element.reticle.WinX=0.000\n"
        "Element.reticle.WinY=0.000\n"
        "Element.reticle.WinScale=1.000\n"
        "Element.equipment.WinX=-0.010\n"
