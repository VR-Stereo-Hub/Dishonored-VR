...
static void WriteDefaultIni(const char* ini)
{
    ...
    fprintf(f,
        ...
        "HandTilt=0.000\n"
        "; MenuInWindow=1 lets the in-game screens (pause, note, journal, store, mission stats,\n"
        "; each with its own Window<Context> opt-in) ride the HUD window with the world in\n"
