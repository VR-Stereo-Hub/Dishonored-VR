...
static void WriteDefaultIni(const char* ini)
{
    ...
    fprintf(f,
        ...
        "; VR-149 / VR-148, both default OFF with a live F10 HUD toggle.\n"
        "; NativeHeartAllSymbols=1 treats EVERY Heart marker, not only the one whose\n"
        "; Flash symbol is runeMarker. Bone charms ride the same marker and differ\n"
        "; only by that symbol, which has never been read; the hud/heart-symbol log\n"
        "; line names each symbol a run sees whether this is on or off.\n"
        ...
        "; to the default row and ride the default window panel. UNVERIFIED.\n"
        "NativeHeartAllSymbols=0\n"
        "NativeAwarenessMarkers=0\n"
