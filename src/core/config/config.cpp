...
static void WriteDefaultIni(const char* ini)
{
    ...
    fprintf(f,
        ...
        "Census=0\n"
        "[Hud]\n"
        "; HUD grouping candidates default off; F10 HUD exposes live comparison toggles.\n"
        "GroupInteractions=0\n"
        "RouteObjectives=0\n"
        ...
        "ReadingAlphaGamma=0.500\n"
        "ReadingAlphaMix=1.000\n"
        "InteractionAlphaMode=repair\n"
        "InteractionAlphaGain=1.000\n"
        "InteractionAlphaFloor=0.000\n"
        "InteractionAlphaGamma=0.500\n"
