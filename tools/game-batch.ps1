...
#
# Read results from the LOG (tools/tail-log.ps1), not from here.
#
# Usage:
#   .\tools\game-batch.ps1 -Delay 2.5 "fgfov addr 48410488" "fgfov on" "fovaudit"
#   .\tools\game-batch.ps1 "recenter"
#
