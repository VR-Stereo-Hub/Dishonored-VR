...
# VR-198: the installer ships beside the zip. It embeds its own copy of d3d9.dll,
...
if (Test-DvrLegacyDll $staged) { throw "REFUSING to package: the installer's embedded d3d9.dll has the legacy code compiled in." }
