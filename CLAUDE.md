...
| `docs/dishonored/PHYSICAL_SWING.md` | **The motion sword** (VR-37): the edge and sustain detectors, the sample feed and why it keys on the hand generation, the gates, the attack pulse and the honoured-check, every `[Melee]` key and `swing` word, the headset tuning guide, the graveyard |
