...
2026-09-22: X -14.4, Y -30.0 (Y at the old +/-30 limit), then 9.0 / -53.4 on the wider
sliders, now the shipped default; the sliders
reach +/-90 and a "Tested position" button restores it. The dot now stays up while an object is carried (a carry hands the arms back to the game,
which used to blank it, and the throw rides this ray). The F10 section had not written the two
